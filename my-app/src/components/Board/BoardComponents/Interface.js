...
export default function TopHeader() {
    ...
    //Listen the changing of options
    useEffect(() => {
        if (options === "reset"){
    ...
    //Execute when permission changing
    useEffect(() => {
        permissionControl();
    }, [permission])
    ...
    //inputvalue will auto change when typing the keyboard
    ...
    //handle export JSON elements string
    ...
    //function support for resolve file
